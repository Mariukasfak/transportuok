...
const BuitineTechnika = () => {
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Nemokamas šaldytuvų, skalbimo mašinų, viryklių išvežimas Kaune. Profesionalus ir greitas aptarnavimas, ekologiškas utilizavimas. Užsakykite išvežimą dabar!');
    }
    ...
    if (ogDescription) ogDescription.setAttribute('content', 'Profesionalus buitinės technikos išvežimas Kaune. Išvežame šaldytuvus, skalbimo mašinas, virykles. Nemokamas išvežimas ir ekologiškas utilizavimas.');
    if (ogUrl) ogUrl.setAttribute('content', 'https://transportuok.lt/paslaugos/buitines-technikos-isvezimas');
    ...
    canonical.setAttribute('href', 'https://transportuok.lt/paslaugos/buitines-technikos-isvezimas');
  }, []);
