#!/usr/bin/env python3
"""Sukurti šventinį paveikslėlį - tik šventiniai elementai (be dėžės ir kasnpino)"""
...
# Dekoracijos: Auksinės snaigės ir žvaigždės
random.seed(2026)
...
# Dekoratyvinė linija (viena auksinė linija)
...
# NĖRA DĖŽĖS, NĖRA KASNPINO - TIK ŠVENTINIAI ELEMENTAI!

# Papildomi šventiniai simboliai - snaigės apačioje
draw_text_centered(draw, "❄ ★ ❄", 720, footer_font, (255, 215, 0))
...
print('\n✓ Paveikslėlis atnaujintas - tik šventiniai elementai!')
